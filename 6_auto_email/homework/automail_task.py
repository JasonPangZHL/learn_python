...
#邮件批量发送
def batch_mail(name,type,qr,email):
    # 先定义好发件人的邮箱地址和密码
    user = 'python_wanmen@163.com'
    user = 'pangzhl1988@163.com'
    pwd = 'QABIFWHJLXZPZNSA'
    # 目标收件人的邮箱地址
    target_mail = 'python_wanmen@163.com'
    target_mail = email
    # 然后定义好我们要使用的邮箱服务
    ...
    html_content_NOR = '''
    <html>
        <h1 style="color:blue;margin-left:20px"> 尊敬的 %s 你好 </h1>
        <p>万门大学近期推出Python特训营项目，请点击下方链接关注我们</p>
        <p>让知识改变人生！</p>
        <a href = "https://www.wanmen.org">更多好课请关注万门大学</a>
        <p><img style = "width:100px" src='https://imgs.wanmen.org/3c8db5220d7cf0dc7b6ef81f524fea60.png'></p>
...
if __name__ == '__main__':
    ...
    for info in user_info: #[[0,],[2]]
        ...
        #调用批量邮件发送
        batch_mail(name=name,type=type,qr=qrfile,email=email)
        print('发送成功！')
