...
def convertor():
    for file in os.listdir('files'):
        ...
        if 'pptx' in file:
            pptTOPDF(os.path.join(os.path.abspath('files'),file),os.path.join(os.path.abspath('pdfs'), file.split('.')[0]+'.pdf'))
        elif 'docx' in file:
            DocToPDF(os.path.join(os.path.abspath('files'),file),os.path.join(os.path.abspath('pdfs'), file.split('.')[0]+'.pdf'))
