...
#下载到指定目录
fp.set_preference("browser.download.dir","D:\QMDownload")
fp.set_preference("browser.download.forbid_open_with", True)  # 不打开保存的提示框
fp.set_preference("browser.altClickSave", True)  # 快速保存
#不询问下载路径；后面的参数为要下载页面的Content-type的值
fp.set_preference("browser.helperApps.neverAsk.saveToDisk","'browser.helperApps.neverAsk.saveToDisk','application/octet-stream ,application/zip,application/kswps,application/pdf'")
